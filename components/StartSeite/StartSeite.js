...
import {
	attributes,
	react as StartSeiteInhalt
} from "../../content/StartSeite.md";

let { title, methodik_didaktik } = attributes;
	...
	render() {
		return (
			<div>
				...
				<Home />
				{/* <VideoComponent /> */}
				<MethodikDidaktik inhalt={methodik_didaktik} />
				<TwoColSection
					isWhite={true}
					aside={twoColSection[0].aside}
					img={poster}
					title={twoColSection[0].title}
					title2={twoColSection[0].title2}
					description={twoColSection[0].description}
					link={twoColSection[0].link}
				/>
				<Zukunft />
				<Card />
				<OneColSection />
				<TwoColSection
					isWhite={false}
					aside={twoColSection[1].aside}
					img={poster}
					title={twoColSection[1].title}
					title2={twoColSection[1].title2}
					description={twoColSection[1].description}
				/>
				<TextSlider />
				<Partner2 />
				{/* <Blog /> */}
...
const twoColSection = [
	{
		...
		description:
			"- ein Team aus Expert*innen mit langjährige Erfahrung und einer klaren Vision: Digitale Bildung für Alle, nachhaltig und modern.",
